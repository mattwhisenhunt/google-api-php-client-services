...
class Google_Service_Fusiontables_Resource_Table extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param string delimiter The delimiter used to separate cell values.
   * This can only consist of a single character. Default is ,.
   * @opt_param string encoding The encoding of the content. Default is UTF-8.
   * Use auto-detect if you are unsure of the encoding.
   * @opt_param int endLine The index of the line up to which data will be
   * imported. Default is to import the entire file. If endLine is negative, it
   * is an offset from the end of the file; the imported content will exclude
   * the last endLine lines.
   * @opt_param bool isStrict Whether the imported CSV must have the same
   * number of values for each row. If false, rows with fewer values will be
   ...
   * @param array $optParams Optional parameters.
   *
   * @opt_param string maxResults Maximum number of tables to return. Default
   * is 5.
   * @opt_param string pageToken Continuation token specifying which result
   * page to return.
   ...
   * updated. The specified view definition replaces the existing one. Only a
   * view can be updated with a new definition.
   * @return Google_Service_Fusiontables_Table
   */
   ...
   * the last endLine lines.
   * @opt_param bool isStrict Whether the imported CSV must have the same
   * number of column values for each row. If true, throws an exception if the
   * CSV does not have the same number of columns. If false, rows with fewer
   * column values will be padded with empty values. Default is true.
   * @opt_param int startLine The index of the first line from which to start
   * importing, inclusive. Default is 0.
   * @return Google_Service_Fusiontables_Task
   */
